...
date: "2016-09-07"
coverImage: "/img/cradle.jpg"
coverMeta: out
thumbnailImage: "/img/cradle_tn.jpg"
...
```{r echo=FALSE}
blogdown::shortcode('figure', src = '/img/model.png',
                    alt = 'A generative model', class ='figure-img img-fluid rounded',
                    caption = 'Graphical representation of a generative model')
```
