...
tags: ["dataviz"]
date: "2016-11-20"
coverImage: https://drive.google.com/uc?export=view&id=1ql1R0ZHbgQEEoaxbusyiHyxmRh9m1UEv
thumbnailImage: https://drive.google.com/uc?export=view&id=1J-Z5Ml5FMf4mz7TtKOeTdkHNHpH3K3lS
...
![VDQI bookcover](https://www.edwardtufte.com/tufte/graphics/vdqi_bookcover.gif)
...
![Marey's schedule with TGV overlaid](https://drive.google.com/uc?export=view&id=1Jt_ErcIO12lNBwfyhoiMfT7oehMFYVM2)
...
![Trains schedule Zurich-Milano](https://drive.google.com/uc?export=view&id=1mcyLsZ6m-UBR86LFyEQd5BOaKTxiDdoL)
...
```{r marey_plot, message=FALSE, warning=FALSE}
library(tidyverse)
library(ggthemr)
