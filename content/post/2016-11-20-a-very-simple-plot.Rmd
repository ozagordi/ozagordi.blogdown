...
```{r echo=FALSE}
blogdown::shortcode('figure', src = 'https://www.edwardtufte.com/tufte/graphics/vdqi_bookcover.gif',
                    alt = 'VDQI bookcover',
...
```{r echo=FALSE}
blogdown::shortcode('figure', src = '/img/marey_tgv.jpg',
                    alt = "Marey's schedule with TGV overlaid",
                    class = "figure-img img-fluid rounded")
```
...
```{r echo=FALSE}
blogdown::shortcode('figure', src = '/img/gotthard_trains.svg',
                    alt = 'Trains schedule Zurich-Milano',
                    class = "figure-img img-fluid rounded")
```
